...
> 完整功能清单（127 项）：[function_list.md](./function_list.md)
...
├── assets/
│   └── icon.png                     # 应用图标
├── AGENTS.md                        # Cursor 规则 & 实现约束
├── production_describe.md           # 产品愿景 & 路线图
├── function_list.md                 # 编号化功能清单（127 项）
└── pubspec.yaml
```
...
| 文档 | 用途 |
|------|------|
| [AGENTS.md](./AGENTS.md) | 技术约束、数据模型、组件规范——给 AI 编程助手看 |
| [production_describe.md](./production_describe.md) | 产品愿景、用户画像、P2P 架构设想 |
| [function_list.md](./function_list.md) | 完整功能清单（F-101 ~ F-507） |
